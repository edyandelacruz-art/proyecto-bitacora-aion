...
- Orquestación de contexto, memoria y herramientas.
- Flujos de decisión asistidos por IA.
- Automatización de tareas y procesos repetitivos.
- Integración entre IA, bases de datos, archivos y servicios.
...
- Sistemas de seguimiento, evaluación y analítica.
- Herramientas internas de operación y productividad.

### Educación y evaluación
- Diseño de bancos de preguntas.
- Simulacros y sistemas de evaluación.
- Analítica por competencias.
- Reportes e informes automatizados.
- Diseño de experiencias de entrenamiento académico.
- Integración de IA en procesos educativos.

### Ciencia computacional
- Python y R aplicados a problemas científicos.
- Bioinformática.
- Curaduría y análisis de secuencias.
- Modelamiento de sistemas biológicos.
- Automatización de pipelines científicos.
...
- auditar resultados;
- devolver decisiones o recomendaciones a una interfaz principal.

El objetivo es pasar de asistentes aislados a **sistemas coordinados de inteligencia aplicada**.
...
- **Reverse and complement nucleic acid sequences using R** — Coursera Project Network
...
- **Fundamentals of Immunology: T Cells and Signaling** — Rice University
- **Fundamentals of Immunology: Death by Friendly Fire** — Rice University
- **Genes and the Human Condition** — University of Maryland
- **Classical Papers in Molecular Genetics** — Université de Genève
- **From Disease to Genes and Back** — Novosibirsk State University / PolyOmica
...
**software · agentes · arquitecturas · automatizaciones · pipelines · protocolos · sistemas de evaluación · productos digitales**
