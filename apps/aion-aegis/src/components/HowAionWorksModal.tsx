        ...
        <div className="p-6 lg:p-8 flex-1 overflow-y-auto hide-scrollbar space-y-6 text-xs text-[#E5E1E5]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="p-5 rounded-3xl bg-white/5 border border-white/10 space-y-2">
              <span className="text-lg font-bold text-[#D6B36A]">1. Canal Conversacional Omnicanal</span>
              <p className="text-white/80 leading-relaxed">
            ...
            <div className="p-5 rounded-3xl bg-white/5 border border-white/10 space-y-2">
              <span className="text-lg font-bold text-emerald-400">2. Propagación Multidominio</span>
              <p className="text-white/80 leading-relaxed">
            ...
            <div className="p-5 rounded-3xl bg-white/5 border border-white/10 space-y-2">
              <span className="text-lg font-bold text-sky-400">3. Universal Ledger Inmutable</span>
              <p className="text-white/80 leading-relaxed">
            ...
            <div className="p-5 rounded-3xl bg-white/5 border border-white/10 space-y-2">
              <span className="text-lg font-bold text-[#C4B5FD]">4. Exportación XLSX de 24 Pestañas</span>
              <p className="text-white/80 leading-relaxed">
